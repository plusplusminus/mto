				...
				<?php if ( have_posts() ) : ?>
					...
					<article class="page_article js-article">
						...
						<figure id="overview_image_map">
							...
							<image style="overflow:visible;" width="797" height="467" xlink:href="<?php echo get_stylesheet_directory_uri();?>/library/images/companyoverview.png"></image>
							<a xlink:href="http://burjkhalifa.ae/en">
